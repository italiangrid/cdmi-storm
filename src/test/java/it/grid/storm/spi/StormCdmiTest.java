...
import static it.grid.storm.spi.StormStorageBackendFactory.buildFromJsonFile;
import static it.grid.storm.spi.rest.metadata.model.StoRIMetadata.ResourceStatus.NEARLINE;
import static it.grid.storm.spi.rest.metadata.model.StoRIMetadata.ResourceStatus.ONLINE;
import static it.grid.storm.spi.rest.metadata.model.StoRIMetadata.ResourceType.FILE;
import static it.grid.storm.spi.rest.metadata.model.StoRIMetadata.ResourceType.FOLDER;
